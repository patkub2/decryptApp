...
public class Window extends javax.swing.JFrame {
     ...
     * {@link pl.polsl.kubala.patryk.controller}
     */
   ...
   /**
     ...
     *
     * @return boolean containing the value of the private field waiter.
     */
    ...
    /**
     *  sets the value of waiter to true after pressing button causing running the calculations
     */
    public void setWaiterTrue() {
        waiter = true;
    }

    /**
     *  sets the value of waiter to false causing pause of the loop
     */
    public void setWaiterFalse() {
        waiter = false;
    }
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        if (seedInput.getText().isEmpty() || !isNumeric(seedInput.getText())) {
            ...
            System.out.println("setWaiterTrue();\n");
